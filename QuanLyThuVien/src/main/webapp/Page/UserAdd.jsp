    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="/QuanLyThuVien" class="d-block">Lại Hữu Minh</a>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" action="/QuanLyThuVien/user" method="post" id="quickForm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <c:if test="${userEdit.sex == 0}">
                                            <input name="sex" value="Boy" class="form-control" id="sex" placeholder="Nhập giới tính">
                                        </c:if>
                                        <c:if test="${userEdit.sex == 1}">
                                            <input name="sex" value="Girl" class="form-control" id="sex" placeholder="Nhập giới tính">
                                        </c:if>
<%--                                        <input name="sex" class="form-control" id="sex" placeholder="Nhập giới tính (0-Nam , 1 - Nữ)">--%>
                                    </div>
                                    <div class="form-group">
                                        <label for="numberPhone">Số điện thoại:</label>
                                        <input name="numberPhone" value="${userEdit.numberPhone} "class="form-control" id="numberPhone" placeholder="Nhập số điện thoại">
                                    </div>
